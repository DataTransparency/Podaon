export WORKSPACE="${HOME}/git/Classfitter"
export APPLEID="1132280754"
export VENDORID="ClassfitteriOS"
export TEAMID="TQYB6VJLUN"
export PROVIDER="JamesWOOD1426797195"
export BUILD_URL=www.fakeurl.com
export BUILD_NUMBER=0
export PAYLOAD_FILE=/Users/jamesjwood/git/ClassfitterTools/src/tests/deploymentPayload.json
